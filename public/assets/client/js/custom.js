    ...
    $(document).ready(function () {
        ...
        sync2.owlCarousel({
            ...
            afterInit: function (el) {
                el.find(".owl-item").eq(2).addClass("synced");
            }
        });
        ...
        $(function () {
            ...
            $("#loadMore").on('click', function (e) {
                ...
                if ($("article.blog-listing:hidden").length == 0) {
                    $('#loadmsg').html('<div class="alert alert-success">پست خبری دیگری برای بارگذاری وجود ندارد .</div>').fadeIn(700);
        ...
        $(function () {
            ...
            $("section#timeline .load a").on('click', function (e) {
                ...
                if ($(".timeline > li:hidden").length == 0) {
                    $('#loadmsg').html('<div class="alert alert-success">دیگر هیچ رویدادی وجود ندارد .</div>').fadeIn(700);
